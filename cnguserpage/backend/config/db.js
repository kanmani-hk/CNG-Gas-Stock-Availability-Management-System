...
// Connection for User-specific data (profiles, settings, etc.)
export const cngUserConn = mongoose.createConnection(
    process.env.MONGODB_URI || 'mongodb://localhost:27017/cnguserdb',
    dbOptions
);

// Connection for Bunk Admin & Station data
